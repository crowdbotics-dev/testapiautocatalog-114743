...
## Project Structure
    ...
    ├── testapiautocatalog_114743  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_114743`
...
2. Clone this repo and `cd testapiautocatalog_114743`
